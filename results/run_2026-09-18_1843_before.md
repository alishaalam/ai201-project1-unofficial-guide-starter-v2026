...
```
You should expect 9 to 11 hours a week for BIOL 160 Cell Biology (source: course_biol_160.txt and course_biol_160_workload.txt).
```
...
```
You should expect 9 to 11 hours a week for BIOL 160 (course_biol_160.txt and course_biol_160_workload.txt).
```
...
This comes from housing_aldridge_hall.txt and housing_aldridge_hall_laundry.txt.
```
...
```
Laundry costs $1.75 for a wash and $1.50 for a dry in Aldridge Hall (housing_aldridge_hall.txt and housing_aldridge_hall_laundry.txt).
```
...
* Verrill Street Grill (dining_verrill_street_grill.txt)
* North Kitchen (dining_north_kitchen_followup.txt and dining_north_kitchen.txt)
* Halden Hall (dining_halden_hall.txt)
* Kestrel Commons (dining_kestrel_commons.txt)
* The Ridgeway Café (dining_the_ridgeway_cafe.txt)
```
